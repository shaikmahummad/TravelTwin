...
export const adminApi = {
  ...
  createDestination: (data) => request("/admin/destinations", { method: "POST", body: JSON.stringify(data) }),
  updateDestination: (data) => request("/admin/destinations", { method: "POST", body: JSON.stringify(data) }),
  ...
  updateDigitalTwinStatus: (data) => request("/admin/twin-status", { method: "POST", body: JSON.stringify(data) }),
  saveCulture: (data) => request("/admin/cultural-stories", { method: "POST", body: JSON.stringify(data) }),
  createCulturalStory: (data) => request("/admin/cultural-stories", { method: "POST", body: JSON.stringify(data) }),
  createAlert: (data) => request("/admin/alerts", { method: "POST", body: JSON.stringify(data) }),
...
export const demoData = {
  destinations: [
    ...
    { id: "kochi", name: "Kochi", city: "Kochi", state: "Kerala", description: "A coastal archive of spice routes, art and layered communities.", opening_hours: "09:00 - 18:00", entry_fee: 50, best_time_to_visit: "October to March", image: "https://images.unsplash.com/photo-1593693411515-c20261bcad6e?w=300" },
    { id: "kaziranga", name: "Kaziranga", city: "Golaghat", state: "Assam", description: "Grasslands, wetlands and one-horned rhinos.", opening_hours: "06:00 - 16:00", entry_fee: 200, best_time_to_visit: "November to April", image: "https://images.unsplash.com/photo-1535338454770-8be927b5a00b?w=300" },
  ],
  twin: [
    ...
    { destination_id: "kochi", destination: "Kochi", crowd_level: "medium", weather_status: "rainy", safety_status: "safe", route_status: "open", estimated_visit_minutes: 180, best_suggestion: "Start indoors at the Mattancherry Palace before the afternoon rain.", nearby_cultural_event: "Kalamkari demonstration · 2:00 PM" },
    { destination_id: "kaziranga", destination: "Kaziranga", crowd_level: "low", weather_status: "clear", safety_status: "safe", route_status: "open", estimated_visit_minutes: 300, best_suggestion: "Stay with your safari group and take the early grassland route.", nearby_cultural_event: "Mishing craft and food showcase · 5:00 PM" },
  ],
  stories: [
